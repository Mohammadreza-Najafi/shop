            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                    ...
                    <tr>
                        ...
                        <th class="sort pe-1 align-middle white-space-nowrap" data-sort="email">Role</th>
                    ...
                    @foreach($admins as $key =>$admin)
                        ...
                        <tr class="btn-reveal-trigger">
                            ...
                            <td class="name align-middle py-2"><a href="mailto:ricky@example.com">{{$role->name}}</a></td>
