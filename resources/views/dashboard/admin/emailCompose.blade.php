    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="email">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/email/compose.html" aria-expanded="false">
        ...
        <div class="content">
          ...
          <form class="card" action="{{ route('mail.send') }}" method="POST">
            @csrf
            ...
            <div class="card-body p-0">
              <div class="border border-top-0 border-200">
                <input class="form-control border-0 rounded-0 outline-none px-card" id="email-to" type="email" aria-describedby="email-to" placeholder="To" name="email_to" />
              </div>
              <div class="border border-y-0 border-200">
                <input class="form-control border-0 rounded-0 outline-none px-card" id="email-subject" type="text" aria-describedby="email-subject" placeholder="Subject" name="email_subject" />
              </div>
              <div class="min-vh-50">
