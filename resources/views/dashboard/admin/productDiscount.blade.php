        ...
        <div class="card-header">
            <div class="row flex-between-center">
                ...
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">product in discount</h5>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                    ...
                    <tr>
                        ...
                        <th>Product</th>
                        <th class="text-center">discount persent(%)</th>
                        <th class="text-center">price befor discount</th>
                        <th class="text-end">price after discount</th>
                        <th class="pe-card text-end" style="width: 8rem"></th>
                    ...
                    @foreach($productsDiscount as $productDiscount)
                        <tr class="btn-reveal-trigger">
                            ...
                            <td>
                                ...
                                <div class="col-8 py-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h5 class="mb-0 fs--1">
                                                <a class="text-800" href="app/e-commerce/product/product-details.html">{{$productDiscount->product_id}}</a>
                                            </h5>
                                        </div>
                            ...
                            <td class="align-middle text-center fw-semi-bold">{{$productDiscount->discount_percentage}}%</td>
                            <td class="align-middle text-center fw-semi-bold">$31%</td>
                            <td class="align-middle text-end fw-semi-bold">${{$productDiscount->final_price}}</td>
