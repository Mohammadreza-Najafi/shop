        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
            ...
            <div class="d-flex align-items-center">
                <div class="toggle-icon-wrapper">
                    ...
                    <div class="d-flex align-items-center py-3"><img class="me-2" src="#" alt="" width="40" /><span class="font-sans-serif">MRN</span>
                    </div>
                </a>
            </div>
                ...
                <div class="navbar-vertical-content scrollbar">
                    ...
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                            ...
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.users")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">Users</span>
                                </div>
                            </a>
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.order")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">order</span>
                                </div>
                            </a>
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.payment")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">payment</span>
                                </div>
                            </a>
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.productDiscount")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">product in discount</span>
                                </div>
                            </a>
               
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.discountCode")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">discount Coupon</span>
                                </div>
                            </a>
                            <!-- parent pages--><a class="nav-link" href="{{ route("admins")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">admin</span>
                                </div>
                            </a>
                            <!-- parent pages--><a class="nav-link" href="{{route("admin.product")}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">product</span>
                                </div>
                            </a>


                               <!-- parent pages--><a class="nav-link dropdown-indicator" href="#role" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="email">
                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-envelope-open"></span></span><span class="nav-link-text ps-1">Role-Permission</span>
                                </div>
                            </a>
                            <ul class="nav collapse false" id="role">
                                <li class="nav-item"><a class="nav-link" href="{{route('role')}}" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Role</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('permission')}}" aria-expanded="false">
                                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Permission</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('permission')}}" aria-expanded="false">
                                    <div class="d-flex align-items-center"><span class="nav-link-text ps-1">assing permission to roll</span>
                                    </div>
                                </a>
                                <!-- more inner pages-->
                            </li>
