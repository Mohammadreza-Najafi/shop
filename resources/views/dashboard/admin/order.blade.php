                ...
                @foreach($tracks as $track)
                    ...
                    <tr class="btn-reveal-trigger">
                        ...
                        <td class="order py-2 align-middle white-space-nowrap">
                            <a href="../../../app/e-commerce/orders/order-details.html"> <strong>#{{$track->id}}</strong></a> by <strong>Ricky Antony</strong><br><a href="mailto:ricky@example.com">ricky@example.com</a></td>
