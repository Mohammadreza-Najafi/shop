          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  <!-- parent pages-->
                    <a class="nav-link" href="{{route("profile")}}" role="button" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon">
                            <span class="fas fa-calendar-alt"></span></span><span class="nav-link-text ps-1">profile</span>
                        </div>
                    </a>
                    <a class="nav-link" href="{{route("profile.favorite")}}" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon">
                            <span class="fas fa-calendar-alt"></span></span><span class="nav-link-text ps-1">my favorit</span>
                    </div>
                  </a>
                  <!-- parent pages-->
                  <a class="nav-link" href="{{route("profile.order")}}" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="nav-link-icon">
                            <span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">order</span>
                    </div>
                  </a>
                    <!-- parent pages-->
                    <a class="nav-link" href="{{route("profile.address")}}" role="button" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon">
                                <span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">addresses</span>
                        </div>
                    </a>
                    <!-- parent pages-->
                    <a class="nav-link" href="{{route("profile.personalInfo")}}" role="button" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-comments"></span></span><span class="nav-link-text ps-1">Personal Info</span>
                        </div>
                    </a>
                </li>
        ...
        <div class="content">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
              ...
              <li class="nav-item">
                <a class="nav-link px-0 notification-indicator notification-indicator-warning notification-indicator-fill fa-icon-wait" href="{{route("shoppingCart")}}">
                    <span class="fas fa-shopping-cart" data-fa-transform="shrink-7" style="font-size: 33px;"></span>
                    <span class="notification-indicator-number">{{$cart->getNumItem()}}</span>
                </a>
              </li>
